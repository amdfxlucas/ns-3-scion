#include "ns3/scion-raw-socket.h"
...
NS_LOG_COMPONENT_DEFINE("SCIONIpv4RawSocketImpl");

NS_OBJECT_ENSURE_REGISTERED(SCIONIpv4RawSocketImpl);

TypeId
SCIONIpv4RawSocketImpl::GetTypeId()
{
    static TypeId tid =
        TypeId("ns3::Ipv4RawSocketImpl")
            ...
            .AddAttribute("Protocol",
                          ...
                          UintegerValue(0),
                          MakeUintegerAccessor(&SCIONIpv4RawSocketImpl::m_protocol),
            ...
            .AddAttribute("IcmpFilter",
                          ...
                          UintegerValue(0),
                          MakeUintegerAccessor(&SCIONIpv4RawSocketImpl::m_icmpFilter),
            ...
            .AddAttribute("IpHeaderInclude",
                          ...
                          BooleanValue(false),
                          MakeBooleanAccessor(&SCIONIpv4RawSocketImpl::m_iphdrincl),
                          MakeBooleanChecker());
    return tid;
}

SCIONIpv4RawSocketImpl::SCIONIpv4RawSocketImpl()
{
...
void
SCIONIpv4RawSocketImpl::SetNode(Ptr<Node> node)
{
...
void
SCIONIpv4RawSocketImpl::DoDispose()
{
...
Socket::SocketErrno
SCIONIpv4RawSocketImpl::GetErrno() const
{
...
Socket::SocketType
SCIONIpv4RawSocketImpl::GetSocketType() const
{
...
Ptr<Node>
SCIONIpv4RawSocketImpl::GetNode() const
{
...
int
SCIONIpv4RawSocketImpl::Bind(const Address& address)
{
...
int
SCIONIpv4RawSocketImpl::GetSockName(Address& address) const
{
...
int
SCIONIpv4RawSocketImpl::GetPeerName(Address& address) const
{
...
int
SCIONIpv4RawSocketImpl::ShutdownSend()
{
...
int
SCIONIpv4RawSocketImpl::ShutdownRecv()
{
...
int
SCIONIpv4RawSocketImpl::Connect(const Address& address)
{
...
uint32_t
SCIONIpv4RawSocketImpl::GetTxAvailable() const
{
...
int
SCIONIpv4RawSocketImpl::Send(Ptr<Packet> p, uint32_t flags)
{
...
int
SCIONIpv4RawSocketImpl::SendTo(Ptr<Packet> p, uint32_t flags, const Address& toAddress)
{
...
uint32_t
SCIONIpv4RawSocketImpl::GetRxAvailable() const
{
...
Ptr<Packet>
SCIONIpv4RawSocketImpl::Recv(uint32_t maxSize, uint32_t flags)
{
...
Ptr<Packet>
SCIONIpv4RawSocketImpl::RecvFrom(uint32_t maxSize, uint32_t flags, Address& fromAddress)
{
...
void
SCIONIpv4RawSocketImpl::SetProtocol(uint16_t protocol)
{
...
bool
SCIONIpv4RawSocketImpl::ForwardUp(Ptr<const Packet> p,
                             Ipv4Header ipHeader,
...
bool
SCIONIpv4RawSocketImpl::SetAllowBroadcast(bool allowBroadcast)
{
...
bool
SCIONIpv4RawSocketImpl::GetAllowBroadcast() const
{
