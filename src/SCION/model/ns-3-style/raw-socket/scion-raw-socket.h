#ifndef SCION_IPV4_RAW_SOCKET_IMPL_H
#define SCION_IPV4_RAW_SOCKET_IMPL_H
 ...
 */
class SCIONIpv4RawSocketImpl : public Socket
{
  public:
    /**
...
#endif /* SCION_IPV4_RAW_SOCKET_IMPL_H */
